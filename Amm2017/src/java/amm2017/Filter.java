            ...
            String command = request.getParameter("cmd");
                ...
                if(command!=null){
                    ...
                    if (command.equals("search")){
                        List<Iscritto> usersList;
                        
                        if(!filter.isEmpty()){
                            usersList = IscrittoFactory.getInstance().getIscrittiList(request.getParameter(filter));
                        } else{
                            usersList = IscrittoFactory.getInstance().getIscrittiList();
                        }
